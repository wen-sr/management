...
public class JiaoCaiInventory_detail {
    ...
    public JiaoCaiInventory_detail(Long id, String issuenumber, String subcode, Integer qtyreceipt, Integer qtyallocated, Integer qtyshipped, Integer qtyfree, Integer pack, String loc, String bk1, String bk2, String bk3, String bk4, String bk5) {
        this.id = id;
