...
public class WxMenuController implements WxMpMenuService {
  ...
  public String menuCreateSample() throws WxErrorException {
    ...
    menuButton2.setUrl("http://www.jxxh56.com/management/page/wechat/staffIndex.html");
    ...
    lx3.setName("我的工资");
    lx3.setType("view");
    lx3.setUrl("http://www.jxxh56.com/management/oa/wechat/auth?returnUrl=/page/lhwl/performanceWeChat.html");
