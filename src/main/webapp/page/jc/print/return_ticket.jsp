...
<html>
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/jc/return_ticket.js"></script>
  </head>
  
  <body>
  	<h1 align="center">退货票签打印</h1>
  	<div align="center" class="query">
  		输入征订代码： <input class="easyui-textbox" id="subcode" style="width:150px" /> 
