...
<html>
  ...
  <body>
	<div align="center">
		<h2 style="color:#0078CA">&nbsp;打印</h2>
	</div>
	<div align="center">
		选择批次号：<input type="text" id="batchno" class="easyui-combobox"
				data-options="url:'/management/jc/print/loadBatchno',method:'get',valueField:'batchno',textField:'batchno',panelHeight:120" />
	...
	补打拣货清单：选择拣货流水号：<input type="text" id="pickno" class="easyui-combobox"
				data-options="url:'/management/jc/print/loadPickno',method:'get',valueField:'pickno',textField:'pickno',panelHeight:120" />
