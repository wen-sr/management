...
<html>
	...
	-->
		...
		<script type="text/javascript" src="inventoryDistribution.js"></script>
	</head>
	...
	<body>
		...
		<form action='' id="inputform" align="center">
			<select id="type" class="easyui-combobox" style="width:120px;height:auto;">
		...
		<div id="w-addInfo" class="easyui-window" title="进行分发"
			...
			<form>
				...
				<tr>
					<td>期号:</td><td><select class="easyui-combobox" id="add_issuenumber" data-options="url:'/management/jc/issuenumber/tips',method:'get',valueField:'issuenumber',textField:'issuenumber',panelHeight:'200',readonly:true,width:155" ></select></td>
				...
				<tr>
					<td>出版社：</td><td><select class="easyui-combobox" id="add_publisher" data-options="url:'/management/jc/storer/tips?type=1',method:'get',valueField:'storerkey',textField:'shortname',panelHeight:'200',readonly:true,width:155" ></select></td>
					<td>定价：</td><td><input class="easyui-textbox" data-options="readonly:true" type="text" id="add_price"/></td>
				</tr>
				<tr>
					<td>分发店：</td><td><select class="easyui-combobox" id="add_code" data-options="url:'/management/jc/storer/tips?type=0',method:'get',valueField:'storerkey',textField:'shortname',panelHeight:'200',width:155,required:true" ></select></td>
					<td>分发数量：</td><td><input class="easyui-textbox" type="text" id="add_qtyallocated" data-options="required:true"/></td>
				</tr>
				<tr>
					<td>可分发数</td><td><input class="easyui-textbox" id="add_qtyfree" data-options="readonly:true" /></td>
				</tr>
				<tr>
		...
		<div id="w-editInfo" class="easyui-window" title="修改分发信息"
			...
			<form id="form1">
				...
				<tr>
					<td>分发店：</td><td><select class="easyui-combobox" id="edit_code" data-options="url:'/management/jc/storer/tips?type=0',method:'get',valueField:'storerkey',textField:'shortname',panelHeight:'200'" ></select></td>
