...
function getData(){
    $.ajax({
        ...
        success:function (res) {
            ...
            $("#three").html("");
            $("#four").html("");
            var t1 = "<table id='t1' cellpadding='0' cellspacing='0' style='font-size: 16px;width: 100%;font-weight:normal;border-spacing:0px 1.5px;'><thead><tr><td>作业类型</td><td>应完成</td><td>已完成</td><td>未完成</td><td>完成率</td></tr></thead>" +
                "<tbody>";
