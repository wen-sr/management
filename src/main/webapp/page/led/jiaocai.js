...
function test(){
    ...
    $("#three").html("");
    $("#four").html("");
    var t1 = "<table id='t1' cellpadding='0' cellspacing='0' style='font-size: 18px;width: 100%;font-weight:normal;border-spacing:0px 1.5px;'><thead><tr><td>作业类型</td><td>已完成（托）</td><td>已完成（册）</td></tr></thead>" +
        "<tbody>";

    t1 += "<tr><td>教材收货</td><td>15</td><td>21000</td></tr>";
    t1 += "<tr><td>教辅收货</td><td>23</td><td>33120</td></tr>";
    t1 += "<tr><td>教参收货</td><td>16</td><td>17280</td></tr>";
    t1 += "<tr><td>教辅退货</td><td>6</td><td>8160</td></tr>";

    t1 += "</tbody></table>";
    $("#one").html(t1);$("#one").html(t1);
}
